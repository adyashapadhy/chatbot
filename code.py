...
class Chatbot(Frame):
    ...
    def load_gui(self):
        ...
        self.my_img = ImageTk.PhotoImage(Image.open("/Users/adyasha/Desktop/college/python progs/chatbot/chatbot/chatbot.png"))
    ...
    def Letchat(self):
        ...
        self.image = Image.open('/Users/adyasha/Desktop/college/python progs/chatbot/chatbot/chatbot1.png')
